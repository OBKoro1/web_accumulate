...
![](https://github.com/OBKoro1/articleImg_src/blob/master/juejin/16518cf40dd44b7c?w=1917&h=363&f=png&s=145894?raw=true)

此时如果还不能复制的话，就要去找`user-select`样式,取消这个样式就可以了。

![](https://github.com/OBKoro1/articleImg_src/blob/master/juejin/16518d4625634931?w=861&h=305&f=png&s=195959?raw=true)
