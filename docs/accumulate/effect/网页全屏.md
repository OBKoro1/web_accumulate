...
![](https://github.com/OBKoro1/articleImg_src/blob/master/juejin/167690a2a5a9ba2c?raw=true)
...
4. 进入全屏时，有一个**默认的提示**：'按esc即可退出全屏模式'，如下图显示：
    ...
    ![](https://github.com/OBKoro1/articleImg_src/blob/master/juejin/167694f2253893bf?raw=true)
